...
import com.peak.core.net.httpserver.router.annotation.UrlRouter;
import com.peak.core.spring.SpringContext;
import com.peak.core.utils.PackageScanner;
	...
	public void init() {
		try {
			...
			list.forEach(ctrl -> {
				...
				// inject to spring
				SpringContext.registerBeanPrototype(ctrl.getName(), ctrl.getName());
			});
