...
import com.peak.core.net.httpserver.router.RouteAction;
import com.peak.core.net.httpserver.router.RouteResult;
import com.peak.core.net.httpserver.router.Router;
...
public class HttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	private void runController(ChannelHandlerContext ctx, FullHttpRequest req) {
		...
		try {
			...
			HttpController instance = (HttpController) SpringContext.getBean(routeResult.target().controllerClazz.getName());
			
//			final HttpController instance = routeResult.target().controllerClazz.newInstance();
